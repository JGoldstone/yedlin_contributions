...
class MyTestCase(unittest.TestCase):
    ...
    def test_identical_output(self):
        target_XYZ_values = sy.calc_target_XYZ_values(USER_ILLUMINANT, CCT, D_UV, sy.macbeth, COLORSPACE)
        ...
        with open(nk_path, 'w') as dest_file:
            sy.write_nuke_node(target_XYZ_values, dest_file=dest_file)
        ...
        with open(csv_path, 'w') as dest_file:
            sy.write_csv(target_XYZ_values, dest_file=dest_file)
